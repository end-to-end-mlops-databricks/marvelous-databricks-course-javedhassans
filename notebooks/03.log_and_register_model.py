...
model_parameters = config.model_parameters # Use model parameters from the config
...
# COMMAND ----------
# Define the preprocessor for categorical and numerical features
preprocessor = ColumnTransformer(
    transformers=[
        ('num', StandardScaler(), num_features), # Standard scaling for numerical features
        ('cat', OneHotEncoder(handle_unknown='ignore'), cat_features)], # One-hot encoding for categorical features
...
model_version = mlflow.register_model(
    ...
    name=f"{catalog_name}.{schema_name}.child_health_model_basic",
    tags={"git_sha": f"{git_sha}"})
